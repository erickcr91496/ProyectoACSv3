...
namespace NavigationDrawerPopUpMenu2.Clases
{
        ...
        public class AFD
        {
            ...
            //    var aFD = obj as AFD;
            //    return aFD != null &&
            //           EqualityComparer<List<int>>.Default.Equals(Q, aFD.Q) &&
            //           EqualityComparer<List<char>>.Default.Equals(X, aFD.X) &&
            //           EqualityComparer<List<Transition>>.Default.Equals(transitions, aFD.transitions) &&
            //           q0 == aFD.q0 &&
            //           EqualityComparer<List<int>>.Default.Equals(F, aFD.F);
            //}
